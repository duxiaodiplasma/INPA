...
gfile = '/home/duxiaodi/inpa/INPUT/159243C04_801.geq'
#                   mc,tstep,steps,Eini,Emax,equ
ini = creatobj.ini(5000,1e-11,10000,20,80,gfile)
...
for mc in np.arange(mc_num):
   ...
   for i in np.arange(steps):
       ...
       #bt = bfield.brzt(sr,sz,sphi,ini.gfile)
...
#'''OUTPUT RESULT'''
np.savez('./OUTPUT/output2.npz',\
	strike_pos=strike_pos,\
    R_ini=R_ini,\
	P_ini=-1.0*np.cos(P_ini/180.*np.pi),\
    E_ini=E_ini,\
	birth_sl=birth_sl,\
    )
#
